...
const ParaAnalise: React.FC = () => {
  ...
  async function loadSolicitations() {
    const { data } = await solicitationService.getSolicitationsToAnalysis();
  ...
  return (
    <Container>
      ...
      <ScrollView keyboardShouldPersistTaps="handled">
        <Title>Solitações para análise</Title>
        <Card>
